...
LDFLAGS_COMM=-lboost_system -lboost_filesystem -lcrypto -pthread -lboost_thread
...
$(EXEC_FILE): $(FOBJECTS_FILE) $(FOBJECTS_COMM) $(MAINO_FILE)
	$(CC) $(FOBJECTS_FILE) $(FOBJECTS_COMM) $(MAINO_FILE) -g -o $@ $(LDFLAGS_FILE) $(LDFLAGS_COMM) 

transaction: $(EXEC_DOWN) $(FHEADERS_DOWN)
$(EXEC_DOWN): $(FOBJECTS_DOWN) $(MAINO_DOWN) $(FOBJECTS_FILE) $(FOBJECTS_COMM)
	$(CC) $(FOBJECTS_DOWN) $(MAINO_DOWN) $(FOBJECTS_FILE) $(FOBJECTS_COMM) \
	-g -o $@ $(LDFLAGS_DOWN) $(LDFLAGS_FILE) $(LDFLAGS_COMM)
...
$(EXEC_OPTION): $(FOBJECTS_OPTION) $(MAINO_OPTION) $(FOBJECTS_FILE) $(FOBJECTS_COMM)
	...
	-g -o $@ $(LDFLAGS_OPTION) $(LDFLAGS_FILE) $(LDFLAGS_COMM)
...
$(EXEC_AGGREGATE): $(FOBJECTS_AGGREGATE) $(MAINO_AGGREGATE) $(FOBJECTS_FILE) \
	...
	$(CC) $(FOBJECTS_AGGREGATE) $(MAINO_AGGREGATE) $(FOBJECTS_FILE) \
		$(FOBJECTS_DOWN) $(FOBJECTS_OPTION) $(FOBJECTS_COMM) \
		-g -o $@ $(LDFLAGS_AGGREGATE) $(LDFLAGS_FILE) $(LDFLAGS_DOWN) $(LDFLAGS_OPTION) $(LDFLAGS_COMM)
